                    ...
                    <div class="main-left-inner flex fl-c fl-1">
                        <div class="main-menu fl-4">
                            <ul>
                                ...
                                <li class="active"><span><i class="fas fa-comment"></i></span>Comments
                                </li>
                                <ul>
                                    <li>
                ...
                <div class="main-right flex fl-4">
                    <div class="main-right-inner flex fl-c">
                        ...
                        <div class="main-right-header">
                            <div class="main-right-header-in flex fl-row">
                                ...
                                <div class="m-r-header-right flex fl-row">
                                    <div>
                                        <div>
                                            <button class="br disabled" id="previousPage" disabled="true">
                                            ...
                                            <div class="p-num">
                                                <ul id="page-num">
                                                    <?php
                                                    $dashObj->getCommentPages('1', 'Pending', $blog->blogID);
                                                    ?>
                                                </ul>
                                            </div>
                        ...
                        <div class="main-right-content fl-4">
                            ...
                            <div id="posts">
                                <?php
                                    $dashObj->getAllComments('1', '1','Pending', $blog->blogID);
                                ?>
                            </div>
                        </div>
                        <!-- Js files -->
