            ...
            <div class="layout-pop-inner">
                ...
                <div class="laypopup-box">
                    ...
                    <div class="l-popup flex fl-c">
                        ...
                        <div class="lt-foo">
                            <div class="bn-button">
                                <button id="topPostsBtn" data-blog="<?php echo $blogID; ?>" data-area="<?php echo $area; ?>"
                                        data-pos="<?php echo $pos; ?>" class="btn-newp">Save changes
                                </button>
                ...
                <?php elseif (!empty($type) && $type === "search"): ?>
                    <div class="l-popup flex fl-c">
                        ...
                        <div class="lt-foo">
                            <div class="bn-button">
                                <button id="searchSaveBtn" data-blog="<?php echo $blogID; ?>" data-area="<?php echo $area; ?>"
                                        data-pos="<?php echo $pos; ?>" class="btn-newp">Save changes
                                </button>
                                <button class="cancel-btn" onclick="window.close();">Cancel</button>
                            </div>
                ...
                <?php elseif (!empty($type) && $type === "html"): ?>
                    <div class="l-popup flex fl-c">
                        ...
                        <div class="lt-foo">
                            <div class="bn-button">
                                <button id="htmlSaveBtn" data-blog="<?php echo $blogID; ?>" data-area="<?php echo $area; ?>"
                                        data-pos="<?php echo $pos; ?>" class="btn-newp">Save changes
                                </button>
                                <button class="cancel-btn" onclick="window.close();">Cancel</button>
                            </div>
                ...
                <?php elseif (!empty($type) && $type === "profile"): ?>
                    <div class="l-popup flex fl-c">
                        ...
                        <div class="lt-foo">
                            <div class="bn-button">
                                <button id="profileBtn" data-blog="<?php echo $blogID; ?>" data-area="<?php echo $area; ?>"
                                        data-pos="<?php echo $pos; ?>" class="btn-newp">Save changes
                                </button>
                                <button class="cancel-btn" onclick="window.close();">Cancel</button>
                            </div>
                ...
                <?php elseif (!empty($type) && $type === "labels"): ?>
                    <div class="l-popup flex fl-c">
                        ...
                        <div class="lt-foo">
                            <div class="bn-button">
                                <button id="labelBtn" data-blog="<?php echo $blogID; ?>" data-area="<?php echo $area; ?>"
                                        data-pos="<?php echo $pos; ?>" class="btn-newp">Save changes
                                </button>
                                <button class="cancel-btn" onclick="window.close();">Cancel</button>
                            </div>
                ...
                <?php elseif (!empty($type) && $type === "list"): ?>
                    <div class="l-popup flex fl-c">
                        ...
                        <div class="lt-foo">
                            <div class="bn-button">
                                <button id="listSaveBtn" data-blog="<?php echo $blogID; ?>" data-area="<?php echo $area; ?>"
                                        data-pos="<?php echo $pos; ?>" class="btn-newp">Save changes
                                </button>
                                <button class="cancel-btn" onclick="window.close();">Cancel</button>
                            </div>
